...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_USER_TABLE=" CREATE TABLE  `user` ( `iduser` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,   `name` VARCHAR(45) NULL, `last_name` VARCHAR(45) NULL," +
                "`password` VARCHAR(45) NULL,`facebook` VARCHAR(255) NULL)";
    ...
    public long insertUser(User user){
        ...
        contentValues.put("facebook",user.getPassword());
    ...
    public List<User>  getUsers(){
        ...
        while (cursor.moveToNext()){
            ...
            users.add(new User(cursor.getLong(0),cursor.getString(1),cursor.getString(2),cursor.getString(3),cursor.getString(4)));
